...
bot = telebot.TeleBot('5233474976:AAHuiW4wAcRMocv0gUmYVwJevrmPTcTCaiQ')  # Создаем экземпляр бота
...
def get_ManOrNot(chat_id):
    ...
    req = requests.get("https://thisartworkdoesnotexist.com/", allow_redirects=True)
    if req.status_code == 200:
        img = BytesIO(req.content)
        bot.send_photo(chat_id, photo=img, reply_markup=markup, caption="Реальна ли эта картина?")
